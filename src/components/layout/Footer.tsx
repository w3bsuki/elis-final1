          ...
          >
            ...
            <form onSubmit={handleSubscribe} className="relative mb-4">
              <Input 
                ...
                className="bg-white dark:bg-gray-800 border-gray-300 dark:border-gray-600 focus:border-green-500 dark:focus:border-green-500 focus:ring-green-500 dark:focus:ring-green-500 pr-12"
                value={email}
              ...
              <Button 
                type="submit"
                className={cn(
                  "absolute right-1 top-1 h-8 w-10 flex justify-center items-center",
                  subscriptionStatus === "idle" && "bg-green-600 hover:bg-green-700",
                  subscriptionStatus === "loading" && "bg-green-600",
                  subscriptionStatus === "success" && "bg-green-600",
                  subscriptionStatus === "error" && "bg-red-600"
                )}
                disabled={subscriptionStatus === "loading" || subscriptionStatus === "success"}
              >
                {subscriptionStatus === "idle" && <Send className="h-4 w-4 text-white" />}
                ...
                {subscriptionStatus === "success" && <CheckCircle className="h-4 w-4 text-white" />}
                {subscriptionStatus === "error" && <AlertCircle className="h-4 w-4 text-white" />}
              </Button>
            </form>
            ...
            {subscriptionStatus === "success" && (
              <motion.p 
                ...
                className="text-green-600 dark:text-green-400 text-sm flex items-center gap-1 mb-4"
              >
            ...
            {subscriptionStatus === "error" && (
              <motion.p 
                initial={{ opacity: 0, height: 0 }}
                animate={{ opacity: 1, height: 'auto' }}
                className="text-red-600 dark:text-red-400 text-sm flex items-center gap-1 mb-4"
              >
