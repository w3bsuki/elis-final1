...
export function Contact() {
  ...
  return (
    <div className="relative z-0">
      ...
      {/* Main content container with enhanced neumorphic styling */}
      <div className="max-w-4xl mx-auto mb-10 bg-white/60 dark:bg-gray-900/60 backdrop-blur-sm rounded-xl border border-blue-200/30 dark:border-blue-800/30 shadow-xl overflow-hidden">
        {/* Inner container with gradient and shadow effects */}
        <div className="bg-gradient-to-br from-blue-50/30 via-white/40 to-blue-50/30 dark:from-blue-900/20 dark:via-gray-900/20 dark:to-blue-900/20 p-6 rounded-lg">
          ...
          <Tabs defaultValue="booking" className="w-full">
            ...
            {/* Booking Calendar - with enhanced container */}
            <TabsContent value="booking" className="mt-8">
              ...
              >
                <div className="bg-white/90 dark:bg-gray-800/90 border border-blue-200/40 dark:border-blue-800/30 rounded-xl p-5 shadow-lg">
                  <div className="relative">
                    {/* Subtle inner glow effect */}
                    <div className="absolute inset-1 bg-white/30 dark:bg-blue-900/10 rounded-lg backdrop-blur-sm shadow-inner pointer-events-none"></div>
                    {/* Calendar inside the nested container */}
            ...
            {/* Contact Form - with enhanced nested containers */}
            <TabsContent value="contact" className="mt-8">
              ...
              >
                ...
                <div className="flex flex-col gap-8">
                  {/* Newsletter Card - Enhanced with nested container */}
                  <div className="rounded-xl border border-blue-200/50 dark:border-blue-700/30 shadow-lg overflow-hidden 
                    bg-gradient-to-br from-white/95 to-blue-50/90 dark:from-gray-800/95 dark:to-blue-900/30">
                    <div className="relative p-6">
                      {/* Subtle decorative element */}
                      <div className="absolute right-0 top-0 w-32 h-32 bg-gradient-to-br from-blue-400/5 to-indigo-500/5 rounded-full blur-xl -z-1"></div>
                      
                      <div className="flex items-center gap-3 mb-4">
                        <div className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-full p-2.5 shadow-md">
                      ...
                      <div className="mt-4 bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm rounded-lg border border-blue-200/50 dark:border-blue-700/30 p-3 shadow-inner">
                        <NewsletterSignup 
                          variant="card"
                          showIcon={true}
                        />
                  ...
                  {/* Contact Information - Enhanced with nested elements */}
                  <div className="rounded-xl border border-blue-200/50 dark:border-blue-700/30 shadow-lg overflow-hidden
                    bg-gradient-to-br from-white/95 to-blue-50/90 dark:from-gray-800/95 dark:to-blue-900/30">
                    <div className="relative p-6">
                      {/* Subtle decorative element */}
                      <div className="absolute left-0 bottom-0 w-32 h-32 bg-gradient-to-tr from-blue-400/5 to-indigo-500/5 rounded-full blur-xl -z-1"></div>
                      
                      <h3 className="text-lg font-bold mb-5 antialiased flex items-center">
                        <div className="bg-gradient-to-br from-blue-100 to-white dark:from-blue-800/40 dark:to-blue-900/60 p-2 rounded-full shadow-sm mr-2">
                      ...
                      {/* Social Media Links - with enhanced nested container */}
                ...
                {/* Right Column - Contact Form - Enhanced with nested container */}
                <div>
                  <div className="rounded-xl border border-blue-200/50 dark:border-blue-700/30 shadow-lg overflow-hidden
                    bg-gradient-to-br from-white/95 to-blue-50/90 dark:from-gray-800/95 dark:to-blue-900/30">
                    <div className="relative p-6">
