...
export const services: Service[] = [
  ...
  {
    id: 'package-2',
    title: 'Среден "Осъзната трансформация"',
  ...
  {
    id: 'package-3',
    title: 'Премиум "Личен Треньор за осъзнато хранене"',
  ...
  // Services for "Вдъхновения: Когато не знаеш как да продължиш напред - книга 2" (ID: 2)
  {
    id: 'service-4',
  ...
  {
    id: 'package-4',
    title: 'Пакет "Творческо Вдъхновение"',
    ...
    popular: true,
    includes: [
      'Копие на книгата "Вдъхновения: Когато не знаеш как да продължиш напред - книга 2"',
  ...
  // Services for "Вдъхновения. Когато не знаеш как да продължиш напред - книга 1" (ID: 3)
  {
    id: 'service-5',
  ...
  {
    id: 'package-5',
    title: 'Пакет "Откривател на Думи"',
    ...
    popular: true,
    includes: [
      'Копие на книгата "Вдъхновения. Когато не знаеш как да продължиш напред - книга 1"',
  ...
  // Services for "Дневник на щастието. Слънцето в мен" (ID: 4)
  {
    id: 'service-6',
  ...
  {
    id: 'package-6',
    title: 'Пакет "Пътешествие към Щастието"',
    ...
    popular: true,
    includes: [
      'Копие на книгата "Дневник на щастието. Слънцето в мен"',
